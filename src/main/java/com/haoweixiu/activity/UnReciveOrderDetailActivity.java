...
import com.haoweixiu.gaodemap.activities.RouteActivity;
...
//未接订单详情页面
public class UnReciveOrderDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void getData() {
        ...
        getData_new(hashMap, Task.UNRECIVED_DETAIL);
    }
        ...
        switch (type) {
            ...
            case Task.SEND_ORDER:
                ...
                if (state.equals("1")) {
                    ...
                    showToast("订单已被他人接受！请及时刷新列表！");
                }
                else {
                    showToast("接单失败！清稍后再试！");
                }
                break;
            default:
                break;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btn_receive_order:
                ...
                hashMap.put("did", did.trim());
                Log.i("getData", "===sendorder" + hashMap);
            ...
            case R.id.tv_custom_location:
                if (!activity.equals("ImageMarkerAty")) {
                    Intent intent = new Intent(this, ImageMarkerAty.class);
                    intent.putStringArrayListExtra("list", list);
                    intent.putExtra("activity", "UnReciveOrderDetailActivity");
                    startActivity(intent);
                    finish();
                    break;
                }
